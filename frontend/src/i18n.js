      ...
      settings: {
        ...
        modals: {
          gmail: {
            ...
            step3: 'Add http://localhost:18002, http://localhost:8081, and http://localhost:8082 as redirect URIs',
      ...
      settings: {
        ...
        modals: {
          gmail: {
            ...
            step3: '添加 http://localhost:18002、http://localhost:8081 和 http://localhost:8082 作为重定向 URI',
            step4: '在下方输入你的凭证',
            clientId: '客户端 ID：',
            clientSecret: '客户端密钥：',
